...
const translations = {
  fr: {
    ...
    deviceSearchHint:       'Top 20 populaires — tapez pour en voir plus',
  ...
  en: {
    ...
    deviceSearchHint:       'Top 20 most popular — type to see more',
  ...
  es: {
    ...
    deviceSearchHint:       'Top 20 más populares — escribe para ver más',
